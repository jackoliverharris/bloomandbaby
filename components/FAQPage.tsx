...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Mothers looking for calm, connection, and gentle achievement.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Bloom & Baby is a space where real motherhood is welcomed, not managed.',
    ],
  },
  {
  ...
  },
  {
    ...
    bullets: [
      'GBP 20 per single drop-in session.',
      'GBP 66 for the first 4-week Spring Term (save GBP 14).',
      'GBP 100 for the 2nd 6-week Spring Term (save 20).',
    ],
  ...
  },
  {
    ...
    intro: 'Spring Term 1 sessions currently run:',
    bullets: ['Mondays and Fridays.', '10:30-12:00.'],
    paragraphs: [
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-12 flex items-start justify-between gap-6">
          <div>
            ...
            <h1 className="mt-3 font-editorial text-5xl font-light text-[#FCFBF7] md:text-7xl">FAQ</h1>
        ...
        <div className="space-y-6">
          {faqItems.map((item) => (
            <article
              key={item.question}
              className="rounded-2xl border border-stone-200/30 bg-black/35 p-6 shadow-lg backdrop-blur-[2px] md:p-8"
            >
              <h2 className="font-editorial text-3xl font-light text-[#FCFBF7] md:text-4xl">{item.question}</h2>

              {item.intro && <p className="mt-4 text-lg leading-relaxed text-stone-100">{item.intro}</p>}

              {item.paragraphs?.map((paragraph) => (
                <p key={paragraph} className="mt-4 text-lg leading-relaxed text-stone-100">
                  {paragraph}
                </p>
              ))}
